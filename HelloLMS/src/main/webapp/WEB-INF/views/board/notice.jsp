...
<div class="container">
	...
	<table class="table table-hover">
		...
		<td><div class="span1"><a href="/board/pastNotice">이전 공지</a></div></td>
		</tr>
		<tr>
			<th><div class="span1">번호</div></th>
			<th><div class="span4">제목</div></th>
			<th><div class="span2">작성일</div></th>
			<th><div class="span1; text-align:center;">조회수</div></th>
		</tr>
		<%-- <c:forEach items="${notice}" var="list"> --%>
		<c:forEach items="${notice}" var="list" varStatus="i" begin="${i.end}" end="9">
