...
<form class="form-horizontal" role="form" id="editorForm" method="post" action="/board/notice/writeNotice" enctype="multipart/form-data">
	<div class="container">
		<div class="page-header">
			<h1>
				공지사항 작성 <small>...공지사항을 작성합니다.</small>
			</h1>
		</div>
		...
		<table class="table table-bordered">
			<tr>
				...
				<td><div class="span5">
						<input name="bxnsubject" style="background-color: transparent; border: 0" placeholder="제목을 입력하세요." required="required">
					</div></td>
			</tr>
		</table>
		<table class="table table-bordered">
			<tr>
				<td><textarea class="ckeditor" id="ckeditor" cols="80" name="bxncontent" rows="20"></textarea></td>
			</tr>
			<tr>
				<td align="right"><input id="file1" type="file" name="file" value="${originalFileName}">
				<button id="addFile" class="btn btn-default btn-sm" type="button">파일추가</button></td>
			</tr>
