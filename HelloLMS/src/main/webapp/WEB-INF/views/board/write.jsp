...
<body>
	...
	<form action="/board/notice/writeNotice" method="post">
		...
		<div class="container">
			...
			<table class="table table-bordered">
				<tr>
					...
					<td><div class="span5">
						<input name="bxnsubject" style="background-color: transparent; border: 0" placeholder="제목을 입력하세요." required="required">${notice.bxnsubject}
						</div></td>
				</tr>
			</table>
			<table class="table table-bordered">
